...
class EB_DOLFIN(CMakePythonPackage):
    ...
    def configure_step(self):
        ...
        deps = ['Boost', 'CGAL', 'PETSc', 'Python', #, 'ParMETIS'
                'SLEPc', 'zlib'] # 'SCOTCH', 'SuiteSparse', 'Trilinos'
        ...
        # SUNDIALS
        if any(dep['name'] == 'SUNDIALS' for dep in self.cfg.dependencies()):
            self.cfg.update('configopts', '-DSUNDIALS_DIR:PATH="%s"' % get_software_root('SUNDIALS'))
