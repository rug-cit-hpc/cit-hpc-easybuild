	...
	if (toolbox::run($rsyncCom)==1)
        ...
        else
        {
           my $i = 1;
			...
			{
				sleep 1200;
				toolbox::exportLog("WARN: scp:transfer2origin error, WARNING $i I will delay automatically waiting for your manual stop (kill the job)\n",2);
				$i ++;
			}
