...
do
  echo \${modulefile}
  # Make a copy of the module files to restore later
  cp -p \${modulefile} \${modulefile}.bak
  # Remove MODULEPATH changes
  sed -i '/MODULEPATH/d' \${modulefile}
done
...
# Restore old module files with MODULEPATH setting
